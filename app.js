...
function attachInputListeners() {
  ...
  inputIds.forEach(id => {
    ...
    el.addEventListener('input', () => {
      ...
      if (id === 'inp-activity-name') document.getElementById('disp-activity-name').textContent = el.value || 'Kadal Karai Symphony (Episode 2), Beach Cleanup';
      if (id === 'inp-date-venue') document.getElementById('disp-date-venue').textContent = el.value || '20th September 2026, Marina Beach, Chennai';
...
async function buildFilledPdfDocument() {
  ...
  const activityName = document.getElementById('inp-activity-name')?.value.trim() || 'Kadal Karai Symphony (Episode 2), Beach Cleanup';
  const dateVenue = document.getElementById('inp-date-venue')?.value.trim() || '20th September 2026, Marina Beach, Chennai';
