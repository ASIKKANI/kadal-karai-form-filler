...
function attachInputListeners() {
  ...
  inputIds.forEach(id => {
    ...
    el.addEventListener('input', () => {
      ...
      if (id === 'inp-date-venue') document.getElementById('disp-date-venue').textContent = el.value || '23rd August 2026, Ashtalakshmi Temple Beach, Besant Nagar, Chennai';
...
async function buildFilledPdfDocument() {
  ...
  const dateVenue = document.getElementById('inp-date-venue')?.value.trim() || '23rd August 2026, Ashtalakshmi Temple Beach, Besant Nagar, Chennai';
